...
const Footer: FC<FooterProps> = () => {
    return (
        <footer className='footer padding-common'>
            ...
            <a className='footer-link' href='yandex.ru/legal/scooters_seasonpass'> yandex.ru/legal/scooters_seasonpass</a>.
            Доп.опция доступна пользователям с активной подпиской (условия подписки: 
            <a className='footer-link' href='yandex.ru/legal/yandex_plus_conditions'> yandex.ru/legal/yandex_plus_conditions</a>
            ), есть ограничения, подробнее: 
            <a className='footer-link' href='yandex.ru/legal/yandex_plus_opzii_list'> yandex.ru/legal/yandex_plus_opzii_list</a>.
            ...
            <a className='footer-link' href='clck.ru/gwDGn'> clck.ru/gwDGn</a>
            . 0+
            </span>
        </footer>
    );
